...
class BuscarMascotaAdopcion extends Simulation {
	...
	val adoptionSearchScn = scenario("adoptionSearchScn").exec(
		Home.home,
		Login.login,
	...
	setUp(
		adoptionSearchScn.inject(rampUsers(90) during (100 seconds)))
