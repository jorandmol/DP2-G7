...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (10,DATE_ADD(CURRENT_DATE, INTERVAL 2 day),'2020-03-27','Radiographic study',1,1,2);
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (16,DATE_ADD(CURRENT_DATE, INTERVAL 2 day),'2020-04-18','Dental checkup',6,10,3);
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (18,DATE_ADD(CURRENT_DATE, INTERVAL 3 day),'2020-04-23','Toxicologic study',9,21,4);
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (20,DATE_ADD(CURRENT_DATE, INTERVAL 1 day),'2020-03-14','Fluid Analysis and CBC test',2,14,6);
