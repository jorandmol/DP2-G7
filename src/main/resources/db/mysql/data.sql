...
INSERT INTO vets(id,first_name,last_name,address,city,telephone,username) VALUES (1, 'James', 'Carter', '110 W. Liberty St.', 'Madison', '608555102', 'vet1');
INSERT INTO vets(id,first_name,last_name,address,city,telephone,username) VALUES (2, 'Helen', 'Leary','110 W. Liberty St.', 'Madison', '608555102', 'vet2');
INSERT INTO vets(id,first_name,last_name,address,city,telephone,username) VALUES (3, 'Linda', 'Douglas', '110 W. Liberty St.', 'Madison', '608555102', 'vet3');
INSERT INTO vets(id,first_name,last_name,address,city,telephone,username) VALUES (4, 'Rafael', 'Ortega', '110 W. Liberty St.', 'Madison', '608555102', 'vet4');
INSERT INTO vets(id,first_name,last_name,address,city,telephone,username) VALUES (5, 'Henry', 'Stevens', '110 W. Liberty St.', 'Madison', '608555102', 'vet5');
INSERT INTO vets(id,first_name,last_name,address,city,telephone,username) VALUES (6, 'Sharon', 'Jenkins', '110 W. Liberty St.', 'Madison', '608555102', 'vet6');
...
INSERT INTO specialties(id,name) VALUES (4, 'toxicology');
INSERT INTO specialties(id,name) VALUES (5, 'dermatology');
INSERT INTO specialties(id,name) VALUES (6, 'pathology');
INSERT INTO specialties(id,name) VALUES (7, 'nutrition');
...
INSERT INTO vet_specialties(vet_id,specialty_id) VALUES (5, 5);
INSERT INTO vet_specialties(vet_id,specialty_id) VALUES (6, 6);
INSERT INTO vet_specialties(vet_id,specialty_id) VALUES (6, 7);
INSERT INTO vet_specialties(vet_id,specialty_id) VALUES (4, 4);
...
INSERT INTO types(id,name) VALUES (7, 'rabbit');
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (4,'2019-01-24','2019-01-11','Sterilization',3,7,1);
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (8,'2020-08-30','2020-03-27','Dental checkup',1,2,1);
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (10,ADDDATE(CURRENT_DATE, 2),'2020-03-27','Radiographic study',1,1,2);
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (16,ADDDATE(CURRENT_DATE, 2),'2020-04-18','Dental checkup',6,10,3);
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (18,ADDDATE(CURRENT_DATE, 3),'2020-04-23','Toxicologic study',9,21,4);
...
INSERT INTO appointments(id,appointment_date,appointment_request_date,description,owner_id,pet_id,vet_id) VALUES (20,ADDDATE(CURRENT_DATE, 1),'2020-03-14','Fluid Analysis and CBC test',2,14,6);
...
INSERT INTO visits(id,pet_id,visit_date,description) VALUES (11, 18, CURRENT_DATE, 'Annual checkup: Everything looks correct.');

INSERT INTO medical_tests(id,name,description) VALUES (1, 'Radiography', 'It is used to diagnose or treat patients by recording images of the internal structure of the body to assess the presence or absence of disease, foreign objects, and structural damage or anomaly. During a radiographic procedure, an x-ray beam is passed through the body.');
INSERT INTO medical_tests(id,name,description) VALUES (2, 'Sonography', 'It uses ultrasonic sound waves in the frequency range of 1.5-15 megahertz (MHz) to create images of body structures based on the pattern of echoes reflected from the tissues and organs being imaged.');
INSERT INTO medical_tests(id,name,description) VALUES (3, 'Toxicologic test', 'If your veterinarian suspects that your pet has been poisoned, samples will be collected for toxicologic tests to identify the poison and the amount of damage it may have caused. Some common poisons can be quickly identified. Rapid identification of a poison can be critical for your pet''s survival.');
INSERT INTO medical_tests(id,name,description) VALUES (4, 'Serologic test', 'Serology is the study of blood serum and other body fluids. Most serologic tests determine the level of antibodies that are present and reactive against a particular infectious microorganism. ');
INSERT INTO medical_tests(id,name,description) VALUES (5, 'Complete Blood Count (CBC)', 'This test determines the number and types of cells circulating in the bloodstream and provides basic information about anemia, inflammation, and clotting. Determining the number of red blood cells, their size and shape, and their hemoglobin content helps identify disorders such as anemia.');
INSERT INTO medical_tests(id,name,description) VALUES (6, 'Fluid Analysis','Fluid analysis is the study of bodily fluids other than blood (urine, joint fluid, etc). Specialists in analyzing body fluids work closely with other specialists to help provide information about the health of an animal. Typically, fluid analysis includes checking the sample for cells and proteins.');

INSERT INTO visit_medical_tests(visit_id,medical_test_id) VALUES (6, 1);
INSERT INTO visit_medical_tests(visit_id,medical_test_id) VALUES (8, 1);
INSERT INTO visit_medical_tests(visit_id,medical_test_id) VALUES (9, 2);
INSERT INTO visit_medical_tests(visit_id,medical_test_id) VALUES (9, 3);
INSERT INTO visit_medical_tests(visit_id,medical_test_id) VALUES (5, 5);
INSERT INTO visit_medical_tests(visit_id,medical_test_id) VALUES (4, 2);

INSERT INTO medicines(id,name,code,description,expiration_date) VALUES (1, 'Penicillin', 'PEN-2356', 'It doesn''t kill viruses, but it''s sometimes prescribed to treat secondary bacterial infections that can occur when an animal is ill from a viral infection.', '2021-07-04');
INSERT INTO medicines(id,name,code,description,expiration_date) VALUES (2, 'Pet-Dalsy', 'PDA-334', 'Ideal for puppies', '2024-03-04');
INSERT INTO medicines(id,name,code,description,expiration_date) VALUES (3, 'Oxycodone', 'OXD-027', 'This is a potent pain reliever. It must be highly controlled because of their addictive potential.', '2022-10-14');
INSERT INTO medicines(id,name,code,description,expiration_date) VALUES (4, 'Antiparasitic', 'APA-153', 'This is a potent pain reliever. It must be highly controlled because of their addictive potential.', '2024-09-23');
INSERT INTO medicines(id,name,code,description,expiration_date) VALUES (5, 'Methimazole ', 'MET-529', 'This medicine is made for abnormal thyroid hormone levels.', '2023-11-17');
INSERT INTO medicines(id,name,code,description,expiration_date) VALUES (6, 'Atenolol', 'ATN-674', 'Heart medication used to control the circulatory system', '2024-05-09');
...
INSERT INTO stays(id,pet_id,register_date,release_date,status) VALUES (4,21, '2020-10-01', '2020-10-05',0);
