...
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (2, 'Basil', '2012-08-06', 1, 'It is impossible to accept it because the hamster quota has been exceeded', true , 6, 2);
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (3, 'Rosy', '2011-04-17', 2, '', true , 2, 3);
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (4, 'Jewel', '2010-03-07', 0, '', true , 2, 3 );
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (5, 'Iggy', '2010-11-30', 1,'', true , 3, 4 );
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (6, 'George', '2010-01-20', 2, '', true , 4, 5 );
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (7, 'Samantha', '2012-09-04', 0, '', true , 1, 6 );
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (8, 'Max', '2012-09-04', 1, '', true , 1, 6);
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (9, 'Lucky', '2011-08-06', 2, '', true , 5, 7);
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (10, 'Mulligan', '2007-02-24', 0, '', true , 2, 8);
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (11, 'Freddy', '2010-03-09', 1, '', true , 5, 9);
