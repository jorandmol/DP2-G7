...
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (4, 'Jewel', '2010-03-07', 0, '', false , 2, 3 );
INSERT INTO pets(id,name,birth_date,status,justification,active,type_id,owner_id) VALUES (5, 'Iggy', '2010-11-30', 1,'It is impossible to accept it because the lizard quota has been exceeded', true , 3, 3 );
